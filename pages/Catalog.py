...
class CatalogPage(BasePage):
    ...
    profile_math_selector =  "div.mb-9.sm\\:mb-10.md\\:mb-14.lg\\:mb-20 > div > div.base-slider.base-slider--with-offset.base-slider--full-height > div.base-slider__area.no-scrollbar > div:nth-child(3) > div"
    russian_selector =  "[data-scroll-item=\"1\"]"
    ...
    profile_math_sharafiev_locator =  "[data-testid=\"PRODUCT_CARD\"] a[href=\"/ege/math-11-class-artur-sharafiev-8608/\"]"
    ...
    def select_profil_math(self):
        ...
        return MathCatalogPage(self.page)
    ...
    def button_profile_math(self):
        return Button(self.page, self.profile_math_selector, "Кнопка профильной математики")
